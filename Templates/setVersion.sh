...
readmePackagePath='../Assets/i5 Toolkit for Mixed Reality/README.md'
...
sed -i -e "$versionReplaceString" -e "s/\${docPath}/https:\/\/rwth-acis.github.io\/i5-Toolkit-for-Mixed-Reality\/$version\//g" -e "s/\${docImgPath}/Documentation\//g" -e "s/\${docExtension}/html/g" "$readmeMainPath"
sed -i -e "$versionReplaceString" -e "s/\${docPath}//g" -e "s/\${docImgPath}//g" -e "s/\${docExtension}/md/g" "$readmeDocPath"
sed -i -e "$versionReplaceString" -e "s/\${docPath}/https:\/\/rwth-acis.github.io\/i5-Toolkit-for-Mixed-Reality\/$version\//g" -e "s/\${docImgPath}/https:\/\/rwth-acis.github.io\/i5-Toolkit-for-Mixed-Reality\/$version\//g" -e "s/\${docExtension}/html/" "$readmePackagePath"

# =============== Documentation =====================

docPackagePath='../Assets/i5 Toolkit for Mixed Reality/Documentation~/i5-Toolkit-for-Mixed-Reality.md'
...
packageJsonPath='../Assets/i5 Toolkit for Mixed Reality/package.json'
...
cp CHANGELOG.md ../Assets/'i5 Toolkit for Mixed Reality'/CHANGELOG.md
